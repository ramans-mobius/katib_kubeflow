...
name: 2 Katib GNN Tuner Default and URL
...
implementation:
  container:
    image: sanram00/stgnn-image:v41
    command:
      - python3
      - -u
      - -c
      - |
        ...
        print("Inside the Katib Break:")
        print(f"Dataset URL:{args.process_data_url}")
                            ...
                            "containers": [
                                {
                                    ...
                                    "image": "sanram00/stgnn-image:v41",
                                    "command": ["python", "train_usecase1.py"],
                                    "args": sum([
        ...
        for idx, trial in enumerate(trials, start=1):
            paramss = {}
            paramss['projectid'] = f"{args.projectid}"
